      ...
      <ul className="space-y-4">
        ...
        <li className="px-6 py-2 hover:bg-gray-700">
          ...
          {isReportsOpen && (
            <ul className="pl-4 space-y-2">
              ...
              <li className="py-2 hover:bg-gray-600">
                <Link to="reports/acounting">Accounting</Link>
              </li>
            </ul>
          )}
        </li>
        <li className="px-6 py-2 hover:bg-gray-700">
          ...
          {isPackageManagementOpen && (
            <ul className="pl-4 space-y-2">
              <li className="py-2 hover:bg-gray-600">
                <Link to="/esim-management/available-esims">Available eSims</Link>
              </li>
              <li className="py-2 hover:bg-gray-600">
                <Link to="/esim-management/new-esims-packages">New Esim Package</Link>
              </li>
              <li className="py-2 hover:bg-gray-600">
        ...
        <li className="px-6 py-2 hover:bg-gray-700">
          ...
          {isSettingsOpen && (
            <ul className="pl-4 space-y-2">
              ...
              <li className="py-2 hover:bg-gray-600">
                <Link to="/settings/maintenance-mode">Maintenance Mode</Link>
              </li>
              <li className="py-2 hover:bg-gray-600">
                <Link to="/package-management/packages">Packages</Link>
              </li>
