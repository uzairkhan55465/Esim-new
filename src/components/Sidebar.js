      ...
      <ul className="space-y-4">
        ...
        <li className="px-6 py-2 hover:bg-gray-700">
          <div className="flex items-center">
            ...
            <Link className="ps-3 text-[13px]" to="/financial-dashboard">
              Financial Dashboard
            </Link>
          </div>
        </li>
        <li className="px-6 py-2 hover:bg-gray-700">
          <div onClick={() => setDealerManagementOpen(!isDealerManagementOpen)}>
            ...
            <ul className="pl-4 space-y-2 mt-3">
              <li className="py-2 ">
                <div className="flex items-center">
                  ...
                  <Link className="ps-2" to="/dealer-management/companies">
                    Companies
                  </Link>
                </div>
              </li>
              <li className="py-2 ">
                <div className="flex items-center">
                  ...
                  <Link className="ps-2" to="/dealer-management/branches">
                    Branches
                  </Link>
                </div>
              </li>
        ...
        <li className="px-6 py-2 hover:bg-gray-700">
          <div onClick={() => setUserManagementOpen(!isUserManagementOpen)}>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="ps-3 text-[13px]"> User Management</span>
              </div>
            ...
            <ul className="pl-4 space-y-2 mt-3">
              <li className="py-2 hover:bg-gray-600">
                <div className="flex items-center">
                  ...
                  <Link className="ps-2" to="/user-management/all-users">
                    All Users
                  </Link>
                </div>
              </li>
              <li className="py-2 hover:bg-gray-600">
                <div className="flex items-center">
                  ...
                  <Link to="/user-management/add-user">Add User</Link>
                </div>
              </li>
            </ul>
          )}
        ...
        <li className="px-6 py-2 hover:bg-gray-700">
          ...
          {isReportsOpen && (
            <ul className="pl-4 space-y-2">
              <li className="py-2 hover:bg-gray-600">
                <Link to="/reports/packets">Packets</Link>
              </li>
              <li className="py-2 hover:bg-gray-600">
                <Link to="/reports/orders">Orders</Link>
              </li>
              <li className="py-2 hover:bg-gray-600">
                <Link to="/reports/sim-card">Sim Card</Link>
              </li>
            </ul>
          )}
        </li>
        <li className="px-6 py-2 hover:bg-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div
                className="ps-3 text-[13px]"
                onClick={() =>
                  setPackageManagementOpen(!isPackageManagementOpen)
                }
              >
                Package Management
              </div>
          ...
          {isPackageManagementOpen && (
            <ul className="pl-4 space-y-2">
              <li className="py-2 hover:bg-gray-600">
                <Link to="/package-management/add-sim-qr">Add Sim QR</Link>
              </li>
              <li className="py-2 hover:bg-gray-600">
                <Link to="/package-management/buy-esim">Buy eSim</Link>
              </li>
              <li className="py-2 hover:bg-gray-600">
                <Link to="/package-management/packages">Packages</Link>
              </li>
              <li className="py-2 hover:bg-gray-600">
                <Link to="/package-management/plans">Plans</Link>
              </li>
            </ul>
          )}
        </li>
